...
def main(args):
    ...
    # 数据集格式要求
    # test_A, train_A, val_A 存放img图片，而且已经是裁剪好的224*224
    # test_B, train_B, val_B 存放IR音频， wav等无损格式 不支持mp3
...
if __name__ == "__main__":
    ...
    if os.path.exists("../test_args.txt"):
        args = parser.parse_args()
        with open("../test_args.txt","r") as f:
        ...
        parser.add_argument("--n_test", type=float, default=1.0,
                            help="Percentage of test set or the number of test examples.")
        args = parser.parse_args()
